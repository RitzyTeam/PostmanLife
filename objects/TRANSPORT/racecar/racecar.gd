...
# ENGINE SETTINGS
@export var MAX_STEER: float = 1.0 ## POWER OF CAR ROTATION
@export var MAX_TORQUE: float = 15000 ## POWER OF CAR ENGINE
@export var MAX_RPM: int = 5000 ## POWER OF CAR WHEEL ROTATION
# ANIMATORS
